...
class RawEditorState extends EditorState
  ...
  kIsWeb ? ClipboardStatusNotifier(value: ClipboardStatus.notPasteable) : ClipboardStatusNotifier();
  ...
  void handleCursorMovement(LogicalKeyboardKey key,
      bool wordModifier,
      bool lineModifier,
      bool shift,) {
    ...
    if ((rightKey || leftKey) && !(rightKey && leftKey)) {
      newSelection = _jumpToBeginOrEndOfWord(
          newSelection,
          wordModifier,
          leftKey,
          rightKey,
  ...
  TextSelection _handleMovingCursorVertically(bool upKey,
      bool downKey,
      bool shift,
    ...
    final localPosition = TextPosition(
        offset: originPosition.offset - child
            .getContainer()
            .documentOffset);
    ...
    if (position == null) {
      ...
      if (sibling == null) {
        ...
        final finalOffset = Offset(
            child
                .getOffsetForCaret(localPosition)
                .dx,
            sibling
                .getOffsetForCaret(TextPosition(
                offset: upKey ? sibling
                    .getContainer()
                    .length - 1 : 0))
                .dy);
        ...
        position = TextPosition(
            ...
            sibling
                .getContainer()
                .documentOffset + siblingPosition.offset);
      }
    } else {
      position = TextPosition(
          offset: child
              .getContainer()
              .documentOffset + position.offset);
    }
  ...
  TextSelection _jumpToBeginOrEndOfWord(TextSelection newSelection,
      bool wordModifier,
      bool leftKey,
      bool rightKey,
      String plainText,
